...
| **[Visual Studio Test Explorer & Debugging](file:///C:/Users/samuel/source/repos/NT/refs/ninjatrader-unittest/docs/visual-studio-test-adapter.md)** | Native VSTest adapter integration, running tests in Test Explorer, setting breakpoints, and debugging from the Visual Studio UI. |
